            ...
            <div className="flex justify-between items-center gap-2 w-full">
              {destination && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className='bg-white flex items-center gap-2 text-black font-bold 0-2 ol-4 pr-4 rounded-full opacity-70 hover:100 hover:shadow-md'
                >
              ...
              {/* From this part is not showing on the chrome */}
              {postedBy?._id === user?.googleId && (
                <button
                  ...
                  className='bg-white opacity-75 hover:opacity-100 font-bold text-dark text-base rounded-3xl hover:shadow-md outlined-none'
                > 
                  <AiTwotoneDelete />
                </button>
              )}
